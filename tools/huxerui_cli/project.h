...
///        published.
/// @param template_name mcpp package template under `templates/`. Empty selects
///        `app` for an application and `library` for a library, which is what
///        `mcpp new --template huxerui.huxerui:<name>` instantiates.
